<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Student_Registration.aspx.cs"
    Inherits="Student_Registration" %>
...
<body>
    ...
    <div style="width:628px; margin:0 auto;background-color:#CCCCCC;">
        <table cellpadding="5" cellspacing="5" style="width: 627px" >
            <tr>
            ...
            <tr>
                <td align="right" colspan="3">
                    ...
                    <asp:HyperLink ID="HyperLink1" runat="server" 
                        NavigateUrl="~/Student_Login.aspx">If Already Registered click here to login</asp:HyperLink>
                </td>
            </tr>
        </table>
    </div>
