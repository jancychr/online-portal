        ...
        <table class="style1">
            ...
            <tr>
                <td align="center">
                    ...
                    <table cellpadding="5" cellspacing="5">
                        <tr>
                            <td colspan="3" align="center">
                                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="XX-Large" ForeColor="#3333CC"
                                    Text="Faculty Login"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Faculty_Registration.aspx">Click here to Register</asp:HyperLink>
                            </td>
                        </tr>
                    </table>
                </td>
